...
namespace Pine_sTool.BLL 
{
	...
	public partial class PT_MES_SCZJH_ALL_TypeOne
	{
		...
		private readonly Pine_sTool.DAL.PT_MES_SCZJH_ALL_TypeOne dal=new Pine_sTool.DAL.PT_MES_SCZJH_ALL_TypeOne();
		...
		/// 获得数据列表
		/// </summary>
		public List<Pine_sTool.Model.PT_MES_SCZJH_ALL_TypeOne> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Pine_sTool.Model.PT_MES_SCZJH_ALL_TypeOne> DataTableToList(DataTable dt)
		{	
			List<Pine_sTool.Model.PT_MES_SCZJH_ALL_TypeOne> modelList = new List<Pine_sTool.Model.PT_MES_SCZJH_ALL_TypeOne>();		
