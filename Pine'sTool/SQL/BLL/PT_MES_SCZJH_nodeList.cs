...
namespace Pine_sTool.BLL
{
    ...
    public partial class PT_MES_SCZJH_nodeList
    {
        ...
        private readonly Pine_sTool.DAL.PT_MES_SCZJH_nodeList dal = new Pine_sTool.DAL.PT_MES_SCZJH_nodeList();
        ...
        /// 获得数据列表
        /// </summary>
        public List<Pine_sTool.Model.PT_MES_SCZJH_nodeList> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Pine_sTool.Model.PT_MES_SCZJH_nodeList> DataTableToList(DataTable dt)
        {
            List<Pine_sTool.Model.PT_MES_SCZJH_nodeList> modelList = new List<Pine_sTool.Model.PT_MES_SCZJH_nodeList>();
