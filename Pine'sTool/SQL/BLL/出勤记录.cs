...
namespace Pine_sTool.BLL 
{
	...
	public partial class 出勤记录
	{
		...
		private readonly Pine_sTool.DAL.出勤记录 dal=new Pine_sTool.DAL.出勤记录();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Pine_sTool.Model.出勤记录 GetModelByCache(int ID)
		{
			string CacheKey = "出勤记录Model-" + ID;
			...
			return (Pine_sTool.Model.出勤记录)objModel;
		}
		/// <summary>
		/// 获得数据列表
		/// </summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<Pine_sTool.Model.出勤记录> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Pine_sTool.Model.出勤记录> DataTableToList(DataTable dt)
		{	
			List<Pine_sTool.Model.出勤记录> modelList = new List<Pine_sTool.Model.出勤记录>();		
